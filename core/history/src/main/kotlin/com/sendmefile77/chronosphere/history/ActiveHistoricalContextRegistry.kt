 ...
 * presentation adapters (character cards, optional adult visuals, etc.) can query the same active
 * branch without threading HistoryWorkspace through every Compose layer.
 */
